...
public class IncorporationForms extends TableImpl<IncorporationFormsRecord> {
    ...
    private static final long serialVersionUID = 537126628;
    ...
    public IncorporationForms() {
        this(DSL.name("incorporation_forms"), null);
    }
    ...
    public IncorporationForms(String alias) {
        this(DSL.name(alias), INCORPORATION_FORMS);
    }

    /**
     * Create an aliased <code>incorporation_forms</code> table reference
     */
    public IncorporationForms(Name alias) {
        this(alias, INCORPORATION_FORMS);
    }

    private IncorporationForms(Name alias, Table<IncorporationFormsRecord> aliased) {
        this(alias, aliased, null);
    }

    private IncorporationForms(Name alias, Table<IncorporationFormsRecord> aliased, Field<?>[] parameters) {
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.INCORPORATION_FORMS_PKEY);
    }
    ...
    public IncorporationForms as(String alias) {
        return new IncorporationForms(DSL.name(alias), this);
    }
     ...
     */
    @Override
    public IncorporationForms as(Name alias) {
    ...
    public IncorporationForms rename(String name) {
        return new IncorporationForms(DSL.name(name), null);
    }
     ...
     */
    @Override
    public IncorporationForms rename(Name name) {
